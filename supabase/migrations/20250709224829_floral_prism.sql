/*
  ...
  1. New Data
    - Creates test user 'birendra_suthar' with complete profile
    - Adds orders in various states (pending, assigned, completed)
    - Adds order items with proper pricing

  2. Test Scenarios
    - Pending pickup orders for global queue
    - Assigned pickup orders for partner dashboard
    - Completed pickup orders for history view
    - Various service types and item combinations
*/
