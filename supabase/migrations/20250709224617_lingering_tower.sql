/*
  ...
  1. New Data
    - Creates a test user 'birendra_suthar' if not exists
    - Creates test orders in various states for delivery partners
    - Adds order items with proper pricing

  2. Test Scenarios
    - Pending pickup orders (Global Queue)
    - Assigned pickup orders (My Assignments)
    - Completed pickup orders (Completed Pickups)
