/*
  # Fix ambiguous column reference in migration

  This migration creates a test partner for Ramu with proper table aliasing
  to avoid ambiguous column references in SQL queries.
*/
