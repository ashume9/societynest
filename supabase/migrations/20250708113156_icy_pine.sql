/*
  ...
  1. Creates sample user "Ashu Kumar" if not exists
  2. Creates sample partner "Rajesh Kumar" if not exists  
  3. Creates clothing types if not exists
  4. Creates 5 sample orders covering all statuses:
