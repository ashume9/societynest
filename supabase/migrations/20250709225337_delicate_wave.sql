/*
  ...
  1. New Data
    ...
    - Creates test orders for comprehensive testing
    - Adds order items with proper calculations
    - Covers different order statuses and service types

  2. Test Scenarios
    - Pending pickup orders
    - Assigned pickup orders
    - Completed pickup orders
    - Various service types (normal, priority, express)
*/
