/*
  ...
  1. Test Infrastructure
    - 2 Societies with unique names
    - 3 Towers across societies
    - 5 Flats across towers
    - 5 Test users with complete profiles
    - 4 Test partners (ironing, delivery, both types)

  2. Test Orders by Category
  ...
  3. Clothing Types
    - 6 different clothing types with realistic pricing

  4. Order Items
    - Complete order items for all test orders
    - Realistic quantities and pricing

  5. Partner Sessions
    - Test sessions for delivery partners
*/

-- Insert sample societies (handle name uniqueness)
...
-- Insert sample towers (handle society_id + name uniqueness)
...
-- Insert sample flats (handle tower_id + number uniqueness)
...
-- Insert sample users (handle username uniqueness)
...
-- Insert sample partners (handle username and identity_number + society_id uniqueness)
...
-- Insert sample clothing types (handle name uniqueness)
...
INSERT INTO order_items (id, order_id, clothing_type_id, quantity, rate, subtotal) VALUES 
  ...
  ('cc0e8400-e29b-41d4-a716-446655440004', 'bb0e8400-e29b-41d4-a716-446655440001', 'aa0e8400-e29b-41d4-a716-446655440006', 1, 16, 9),
  
  -- Order 2 items (₹280 total)
  ('cc0e8400-e29b-41d4-a716-446655440005', 'bb0e8400-e29b-41d4-a716-446655440002', 'aa0e8400-e29b-41d4-a716-446655440001', 4, 20, 80),
  ('cc0e8400-e29b-41d4-a716-446655440006', 'bb0e8400-e29b-41d4-a716-446655440002', 'aa0e8400-e29b-41d4-a716-446655440004', 3, 26, 78),
  ('cc0e8400-e29b-41d4-a716-446655440007', 'bb0e8400-e29b-41d4-a716-446655440002', 'aa0e8400-e29b-41d4-a716-446655440005', 2, 35, 70),
  ('cc0e8400-e29b-41d4-a716-446655440008', 'bb0e8400-e29b-41d4-a716-446655440002', 'aa0e8400-e29b-41d4-a716-446655440006', 2, 22, 44),
  ('cc0e8400-e29b-41d4-a716-446655440009', 'bb0e8400-e29b-41d4-a716-446655440002', 'aa0e8400-e29b-41d4-a716-446655440002', 1, 16, 8),
  
  -- Order 3 items (₹320 total)
  ('cc0e8400-e29b-41d4-a716-446655440010', 'bb0e8400-e29b-41d4-a716-446655440003', 'aa0e8400-e29b-41d4-a716-446655440001', 5, 25, 125),
  ('cc0e8400-e29b-41d4-a716-446655440011', 'bb0e8400-e29b-41d4-a716-446655440003', 'aa0e8400-e29b-41d4-a716-446655440002', 4, 20, 80),
  ('cc0e8400-e29b-41d4-a716-446655440012', 'bb0e8400-e29b-41d4-a716-446655440003', 'aa0e8400-e29b-41d4-a716-446655440006', 4, 28, 112),
  ('cc0e8400-e29b-41d4-a716-446655440013', 'bb0e8400-e29b-41d4-a716-446655440003', 'aa0e8400-e29b-41d4-a716-446655440003', 1, 30, 3),
  
  -- Order 4 items (₹200 total)
  ('cc0e8400-e29b-41d4-a716-446655440014', 'bb0e8400-e29b-41d4-a716-446655440004', 'aa0e8400-e29b-41d4-a716-446655440003', 4, 18, 72),
  ('cc0e8400-e29b-41d4-a716-446655440015', 'bb0e8400-e29b-41d4-a716-446655440004', 'aa0e8400-e29b-41d4-a716-446655440004', 2, 20, 40),
  ('cc0e8400-e29b-41d4-a716-446655440016', 'bb0e8400-e29b-41d4-a716-446655440004', 'aa0e8400-e29b-41d4-a716-446655440005', 2, 25, 50),
  ('cc0e8400-e29b-41d4-a716-446655440017', 'bb0e8400-e29b-41d4-a716-446655440004', 'aa0e8400-e29b-41d4-a716-446655440001', 2, 15, 30),
  ('cc0e8400-e29b-41d4-a716-446655440018', 'bb0e8400-e29b-41d4-a716-446655440004', 'aa0e8400-e29b-41d4-a716-446655440002', 1, 12, 8),
  
  -- Order 5 items (₹180 total)
  ('cc0e8400-e29b-41d4-a716-446655440019', 'bb0e8400-e29b-41d4-a716-446655440005', 'aa0e8400-e29b-41d4-a716-446655440001', 3, 20, 60),
  ('cc0e8400-e29b-41d4-a716-446655440020', 'bb0e8400-e29b-41d4-a716-446655440005', 'aa0e8400-e29b-41d4-a716-446655440002', 4, 16, 64),
  ('cc0e8400-e29b-41d4-a716-446655440021', 'bb0e8400-e29b-41d4-a716-446655440005', 'aa0e8400-e29b-41d4-a716-446655440006', 2, 22, 44),
  ('cc0e8400-e29b-41d4-a716-446655440022', 'bb0e8400-e29b-41d4-a716-446655440005', 'aa0e8400-e29b-41d4-a716-446655440003', 1, 24, 12),
  
  -- Order 6 items (₹240 total)
  ('cc0e8400-e29b-41d4-a716-446655440023', 'bb0e8400-e29b-41d4-a716-446655440006', 'aa0e8400-e29b-41d4-a716-446655440001', 6, 15, 90),
  ('cc0e8400-e29b-41d4-a716-446655440024', 'bb0e8400-e29b-41d4-a716-446655440006', 'aa0e8400-e29b-41d4-a716-446655440003', 4, 18, 72),
  ('cc0e8400-e29b-41d4-a716-446655440025', 'bb0e8400-e29b-41d4-a716-446655440006', 'aa0e8400-e29b-41d4-a716-446655440004', 2, 20, 40),
  ('cc0e8400-e29b-41d4-a716-446655440026', 'bb0e8400-e29b-41d4-a716-446655440006', 'aa0e8400-e29b-41d4-a716-446655440002', 3, 12, 36),
  ('cc0e8400-e29b-41d4-a716-446655440027', 'bb0e8400-e29b-41d4-a716-446655440006', 'aa0e8400-e29b-41d4-a716-446655440006', 1, 16, 2),
  
  -- Order 7 items (₹160 total)
  ('cc0e8400-e29b-41d4-a716-446655440028', 'bb0e8400-e29b-41d4-a716-446655440007', 'aa0e8400-e29b-41d4-a716-446655440002', 5, 16, 80),
  ('cc0e8400-e29b-41d4-a716-446655440029', 'bb0e8400-e29b-41d4-a716-446655440007', 'aa0e8400-e29b-41d4-a716-446655440006', 3, 22, 66),
  ('cc0e8400-e29b-41d4-a716-446655440030', 'bb0e8400-e29b-41d4-a716-446655440007', 'aa0e8400-e29b-41d4-a716-446655440001', 1, 20, 14),
  
  -- Order 8 items (₹300 total)
  ('cc0e8400-e29b-41d4-a716-446655440031', 'bb0e8400-e29b-41d4-a716-446655440008', 'aa0e8400-e29b-41d4-a716-446655440001', 8, 15, 120),
  ('cc0e8400-e29b-41d4-a716-446655440032', 'bb0e8400-e29b-41d4-a716-446655440008', 'aa0e8400-e29b-41d4-a716-446655440003', 5, 18, 90),
  ('cc0e8400-e29b-41d4-a716-446655440033', 'bb0e8400-e29b-41d4-a716-446655440008', 'aa0e8400-e29b-41d4-a716-446655440005', 2, 25, 50),
  ('cc0e8400-e29b-41d4-a716-446655440034', 'bb0e8400-e29b-41d4-a716-446655440008', 'aa0e8400-e29b-41d4-a716-446655440002', 3, 12, 36),
  ('cc0e8400-e29b-41d4-a716-446655440035', 'bb0e8400-e29b-41d4-a716-446655440008', 'aa0e8400-e29b-41d4-a716-446655440006', 1, 16, 4),
  
  -- Order 9 items (₹400 total)
  ('cc0e8400-e29b-41d4-a716-446655440036', 'bb0e8400-e29b-41d4-a716-446655440009', 'aa0e8400-e29b-41d4-a716-446655440001', 6, 25, 150),
  ('cc0e8400-e29b-41d4-a716-446655440037', 'bb0e8400-e29b-41d4-a716-446655440009', 'aa0e8400-e29b-41d4-a716-446655440004', 4, 32, 128),
  ('cc0e8400-e29b-41d4-a716-446655440038', 'bb0e8400-e29b-41d4-a716-446655440009', 'aa0e8400-e29b-41d4-a716-446655440006', 4, 28, 112),
  ('cc0e8400-e29b-41d4-a716-446655440039', 'bb0e8400-e29b-41d4-a716-446655440009', 'aa0e8400-e29b-41d4-a716-446655440002', 1, 20, 10),
  
  -- Order 10 items (₹220 total)
  ('cc0e8400-e29b-41d4-a716-446655440040', 'bb0e8400-e29b-41d4-a716-446655440010', 'aa0e8400-e29b-41d4-a716-446655440002', 8, 12, 96),
  ('cc0e8400-e29b-41d4-a716-446655440041', 'bb0e8400-e29b-41d4-a716-446655440010', 'aa0e8400-e29b-41d4-a716-446655440003', 3, 18, 54),
  ('cc0e8400-e29b-41d4-a716-446655440042', 'bb0e8400-e29b-41d4-a716-446655440010', 'aa0e8400-e29b-41d4-a716-446655440005', 2, 25, 50),
  ('cc0e8400-e29b-41d4-a716-446655440043', 'bb0e8400-e29b-41d4-a716-446655440010', 'aa0e8400-e29b-41d4-a716-446655440001', 1, 15, 15),
  ('cc0e8400-e29b-41d4-a716-446655440044', 'bb0e8400-e29b-41d4-a716-446655440010', 'aa0e8400-e29b-41d4-a716-446655440006', 1, 16, 5),
  
  -- Order 11 items (₹180 total)
  ('cc0e8400-e29b-41d4-a716-446655440045', 'bb0e8400-e29b-41d4-a716-446655440011', 'aa0e8400-e29b-41d4-a716-446655440001', 4, 20, 80),
  ('cc0e8400-e29b-41d4-a716-446655440046', 'bb0e8400-e29b-41d4-a716-446655440011', 'aa0e8400-e29b-41d4-a716-446655440004', 2, 26, 52),
  ('cc0e8400-e29b-41d4-a716-446655440047', 'bb0e8400-e29b-41d4-a716-446655440011', 'aa0e8400-e29b-41d4-a716-446655440006', 2, 22, 44),
  ('cc0e8400-e29b-41d4-a716-446655440048', 'bb0e8400-e29b-41d4-a716-446655440011', 'aa0e8400-e29b-41d4-a716-446655440002', 1, 16, 4),
  
  -- Order 12 items (₹350 total)
  ('cc0e8400-e29b-41d4-a716-446655440049', 'bb0e8400-e29b-41d4-a716-446655440012', 'aa0e8400-e29b-41d4-a716-446655440001', 10, 15, 150),
  ('cc0e8400-e29b-41d4-a716-446655440050', 'bb0e8400-e29b-41d4-a716-446655440012', 'aa0e8400-e29b-41d4-a716-446655440003', 5, 18, 90),
  ('cc0e8400-e29b-41d4-a716-446655440051', 'bb0e8400-e29b-41d4-a716-446655440012', 'aa0e8400-e29b-41d4-a716-446655440005', 3, 25, 75),
  ('cc0e8400-e29b-41d4-a716-446655440052', 'bb0e8400-e29b-41d4-a716-446655440012', 'aa0e8400-e29b-41d4-a716-446655440002', 2, 12, 24),
  ('cc0e8400-e29b-41d4-a716-446655440053', 'bb0e8400-e29b-41d4-a716-446655440012', 'aa0e8400-e29b-41d4-a716-446655440006', 1, 16, 11),
  
  -- Order 13 items (₹480 total)
  ('cc0e8400-e29b-41d4-a716-446655440054', 'bb0e8400-e29b-41d4-a716-446655440013', 'aa0e8400-e29b-41d4-a716-446655440001', 8, 25, 200),
  ('cc0e8400-e29b-41d4-a716-446655440055', 'bb0e8400-e29b-41d4-a716-446655440013', 'aa0e8400-e29b-41d4-a716-446655440004', 4, 32, 128),
  ('cc0e8400-e29b-41d4-a716-446655440056', 'bb0e8400-e29b-41d4-a716-446655440013', 'aa0e8400-e29b-41d4-a716-446655440006', 5, 28, 140),
  ('cc0e8400-e29b-41d4-a716-446655440057', 'bb0e8400-e29b-41d4-a716-446655440013', 'aa0e8400-e29b-41d4-a716-446655440002', 1, 20, 12),
  
  -- Order 14 items (₹260 total)
  ('cc0e8400-e29b-41d4-a716-446655440058', 'bb0e8400-e29b-41d4-a716-446655440014', 'aa0e8400-e29b-41d4-a716-446655440002', 6, 16, 96),
  ('cc0e8400-e29b-41d4-a716-446655440059', 'bb0e8400-e29b-41d4-a716-446655440014', 'aa0e8400-e29b-41d4-a716-446655440003', 4, 24, 96),
  ('cc0e8400-e29b-41d4-a716-446655440060', 'bb0e8400-e29b-41d4-a716-446655440014', 'aa0e8400-e29b-41d4-a716-446655440005', 2, 35, 70)
ON CONFLICT (id) DO NOTHING;
